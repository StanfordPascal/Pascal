...
const VERSION = '2021.01' ;        // Version for display message
      VERSION2 = 0x2101 ;          // Version for load module
      VERSION3 = 'XL2''2101''' ;   // Version for LIST002 listing
      MXADR = 65535 ;
      SHRTINT = 4095 ;
      HALFINT = 32700 ;
   ...
   //****************************************************************
      ...
      begin (* STRINGCOMPARE *)
        ...
        //******************************************************
            ...
            GEN_STRING_ADRESSE ( LEFT , TRUE , DUMMY_OFFS , RGWORK ) ;
        ...
        with RIGHT do
          begin
            ...
            GEN_STRING_ADRESSE ( RIGHT , TRUE , DUMMY_OFFS , RGWORK ) ;
