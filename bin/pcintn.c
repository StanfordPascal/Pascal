...
#if 0
         printf ("Test: fname = <%s>, fname_neu = <%s>\n",
                 fname, fname_neu);
#endif
...

{
   ...
   fprintf (stderr, "stackpoint. = %d\n", gs -> sp);
   fprintf (stderr, "stack_alloc = %d\n", gs -> stack_alloc);
   fprintf (stderr, "stack_used  = %d\n", gs -> stack_used);
   fprintf (stderr, "store_alloc = %d\n", gs -> store_alloc);
   fprintf (stderr, "store_used  = %d\n", gs -> store_used);
...
#if 0
   printf ("start compare_char_array\n");
...
#if 0
   x = memcmp (wlinks, wrechts, llinks);
#endif
...
#if 0
   printf ("end compare_char_array, x = %d\n", x);
#endif
...

{
   ...
   switch (opnum)
   {
      ...
      case XXX_ASE:
         ...
         /************************************************/
         /*   add set element                            */
         /*   wert1 = number of set element to add       */
         /*   len1 = length of set                       */
         /*   if len1 < 0:                               */
      ...
      case XXX_ASR:
         ...
         if (len1 < 0)
         {
            ...
            wert1 = STACK_I (gs -> sp - 12);
            wert2 = STACK_I (gs -> sp - 8);
            addr = STACK_I (gs -> sp);
            len  = STACK_I (gs -> sp - 4);
      ...
      case XXX_SLD:
         ...
         /************************************************/
         /*   understood 2023.05:                        */
         /*   existing len1 of source set is ignored     */
         /*   is not set, if preceeding operation        */
         /*   is LCA S ... don't know, if this hurts     */
         /************************************************/
