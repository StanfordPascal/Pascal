    ...
    copy %PASECHO% src\pasform.pcode    %PASDIR%
    copy %PASECHO% src\passcan.pcode    %PASDIR%
    copy %PASECHO% src\paslibx.pcode    %PASDIR%
    copy %PASECHO% src\pasutils.pcode   %PASDIR%
    copy %PASECHO% src\passcan.pas      %PASDIR%
    copy %PASECHO% src\paslibx.pas      %PASDIR%
