...
procedure ERROR ( ERRCDE : INTEGER ) ;
   ...
   begin (* ERROR *)
     ERRORCNT := ERRORCNT + 1 ;
     WRITELN ( '****  PERROR ' , ERRCDE : 5 , ' ( NEAR LINE ' , LASTLN
               : 6 , ' OF PROCEDURE ' , CURPNAME , ' )' ) ;
     if ERRCDE = 253 then
      ...
      begin (* BSETOPS *)
                           ...
                           if FALSE then
                             begin
                               ...
                               WRITELN ( TRACEF , 'pcounter       = ' ,
                                         PCOUNTER ) ;
                               WRITELN ( TRACEF , 'fold const uni' ) ;
                               TRACE_SET ( L . PCNST -> , LEN ) ;
                               TRACE_SET ( R . PCNST -> , LEN ) ;
                             end (* then *) ;
        ...
        (************************************)
                               ...
                               begin
                                 if FALSE then
                                   WRITELN ( TRACEF ,
                                       'uni mit sets, rechts konstant'
                                             ) ;
                                 PSVAL . S := R . PCNST -> ;
                                 MIN := L . PLEN ;
                                 if MIN > R . PLEN then
                                   MIN := R . PLEN ;
                                 COMPACT ( R . PCNST -> , MIN , J , CHR
                                           ( 0 ) ) ;
                                 GETQB ( L , Q1 , P1 , MIN ) ;
                                 if FALSE then
                                   begin
                                     WRITELN ( TRACEF , 'min = ' , MIN
                                               ) ;
                                     WRITELN ( TRACEF , 'j   = ' , J )
                                   end (* then *) ;
                                 if MIN >= 0 then
                                   GENSSLIT ( XOC , MIN , Q1 + J , P1 ,
                                              R . PCNST -> ) ;
                                 if LEN > L . PLEN then
                                   begin
