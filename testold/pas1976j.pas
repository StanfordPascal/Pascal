...
program PCOMP ( INPUT , OUTPUT , PRR ) ;
...
var SY : SYMBOL ;
    ...
    FNAME : packed array [ 1 .. STRGLGTH ] of CHAR ;
    FNAMELEN : INTEGER ;
...
procedure SEARCHID ( FIDCLS : SETOFIDS ; var FCP : CTP ) ;
   ...
   var LCP : CTP ;
       DISX_LOCAL : DISPRANGE ;

   begin (* SEARCHID *)
     for DISX_LOCAL := TOP DOWNTO 0 do
       begin
         LCP := DISPLAY [ DISX_LOCAL ] . FNAME ;
         while LCP <> NIL do
           if LCP -> . NAME = ID then
                ...
                begin
                  ...
                  if SY = STRINGSY then
                    begin
                      ...
                      CONSTANT ( FSYS + [ RPARENT , RBRACK ] , LSP1 ,
                                 VALS ) ;
                      if LSP1 = INTPTR then
                        begin
